...
Reimplement from scratch all alone in code "Neural Networks: Zero to Hero" Andrej Karpathy's course.  
This course is an introduction to neural networks from the basics to modern architectures such as the GPT-2 (124M parameters) at pretraining stage in code.  
